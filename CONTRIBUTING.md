...
- Prefer parameterization via CLI args or config files over hardcoded paths.
- Do not commit generated artifacts (results, model runs, exported tables, downloaded model weights).
